...
class SqlResultAgentClient:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "Do not write LOWER/REPLACE normalization predicates for those fields when a canonical value is available; "
            "use normal equality or IN predicates over the canonical value. If multiple values are plausible, do not "
            "guess: leave sql empty or explain the ambiguity in plan.risk_notes. "
